...
![Model comparison](docs/screenshots/01-model-comparison.png)
...
| One week: actual vs. predicted | Error distribution |
|---|---|
| ![](docs/screenshots/02-forecast-week.png) | ![](docs/screenshots/03-error-distribution.png) |

| Live day chart |
|---|
| ![](docs/screenshots/04-live-day-chart.png) |
...
the operator-forecast benchmark — in [`docs/TECHNICAL.md`](docs/TECHNICAL.md).
